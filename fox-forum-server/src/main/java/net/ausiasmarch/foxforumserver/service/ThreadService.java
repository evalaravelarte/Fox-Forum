...
public class ThreadService {
    ...
    public ThreadEntity get(long id) {
        return oThreadRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Thread not found")); //encontrar un registro, si no lanza excepcion
    }
    ...
    public ThreadEntity update (ThreadEntity oThreadEntity) {
        ThreadEntity oThreadEntityAux = oThreadRepository.findById(oThreadEntity.getId()).orElseThrow(() -> new ResourceNotFoundException("Thread not found"));
    ...
    public ThreadEntity delete (Long id) {
        ThreadEntity oThreadEntityAux = oThreadRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Thread not found"));
