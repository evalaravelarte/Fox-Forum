...
public class UserService {
    ...
    public UserEntity get(long id) {
        return oUserRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("User not found")); //encontrar un registro, si no lanza excepcion
    }
    ...
    public Long populate (Integer amount) {
        for(int i=0;i < amount;i++) {
            oUserRepository.save(new UserEntity("name" + i, "surname" + i, "lastname" + i, "email" + i, "username" + i, "e2cac5c5f7e52ab03441bb70e89726ddbd1f6e5b683dde05fb65e0720290179e", true));
        }
